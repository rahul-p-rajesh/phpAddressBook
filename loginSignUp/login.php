            ...
            <div class='col d-flex justify-content-center'>
              <form  action = './login.php'  onsubmit = 'return validation()' method = 'POST'>
                <div class='form-group'>
                  ...
                  <input type='text' class='form-control' name='user' aria-describedby='userName' required>
                </div>
                <div class='form-group '>
                  <label for='pass'>Password</label>
                  <input type='password' class='form-control' name='pass' required>
                </div>
                <button type='submit' class='btn btn-primary' class= 'login' name='login'>Login</button>
              </form>
            </div>
        </div>
      </div>
